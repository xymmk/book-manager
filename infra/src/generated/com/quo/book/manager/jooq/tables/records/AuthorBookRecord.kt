...
import com.quo.book.manager.jooq.tables.interfaces.IAuthorBook
...
open class AuthorBookRecord() : UpdatableRecordImpl<AuthorBookRecord>(AuthorBook.AUTHOR_BOOK), IAuthorBook {
    ...
    override fun from(from: IAuthorBook) {
        this.bookId = from.bookId
        this.authorId = from.authorId
        resetChangedOnNotNull()
    }

    override fun <E : IAuthorBook> into(into: E): E {
        into.from(this)
        return into
    }
