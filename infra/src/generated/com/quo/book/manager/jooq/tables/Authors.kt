...
open class Authors(
    ...
    /**
     * The column <code>public.authors.author_id</code>.
     */
    val AUTHOR_ID: TableField<AuthorsRecord, Int?> = createField(DSL.name("author_id"), SQLDataType.INTEGER.nullable(false).identity(true), this, "")

    /**
     * The column <code>public.authors.author_name</code>.
     */
    val AUTHOR_NAME: TableField<AuthorsRecord, String?> = createField(DSL.name("author_name"), SQLDataType.VARCHAR(500).nullable(false), this, "")
